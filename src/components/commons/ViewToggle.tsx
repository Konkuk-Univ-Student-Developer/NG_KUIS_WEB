  ...
  return (
    <div className={`flex bg-beige rounded-[8px] p-[5px] ${className}`}>
      <button
        ...
        className={`px-3 py-1.5 rounded-[3px] flex items-center gap-2 transition-colors  cursor-pointer ${value === 'List'
      ...
      <button
        ...
        className={`px-3 py-1.5 rounded-[3px] flex items-center gap-2 transition-colors  cursor-pointer ${value === 'Card'
          ? 'bg-white text-darkgreen'
          : 'text-darkgray hover:text-black'
          }`}
      >
