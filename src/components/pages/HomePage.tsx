    ...
    <div className="min-h-screen bg-lightgray">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-md mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <div className="text-sm font-bold">Konkuk University</div>
            </div>
      ...
      <div className="max-w-md mx-auto px-4 py-6 space-y-6">
        ...
        <div className="relative">
          <Search className="absolute left-3 top-3 h-5 w-5 text-coolgray" />
          <input
            type="text"
            placeholder="검색어를 입력하세요"
            className="w-full pl-10 pr-4 py-3 border border-lightgray rounded-lg focus:outline-none focus:ring-2 focus:ring-blue"
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm">
          <h2 className="text-mobile-medium-bold mb-4">QUICK MENU</h2>
          <div className="grid grid-cols-2 gap-4">
            {quickMenuItems.map((item, index) => (
              <button
                key={index}
                onClick={item.onClick}
                className="flex flex-col items-center p-4 bg-lightgray rounded-lg hover:bg-beige transition-colors"
              >
                {item.icon}
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <Bell className="w-5 h-5 text-coolgray" />
          </div>
          <div className="space-y-3">
            <div className="p-3 bg-blue/10 rounded-lg border-l-4 border-blue">
              <div className="flex items-center justify-between">
                <span className="text-mobile-small-bold">수강신청 안내</span>
                <span className="px-2 py-1 text-xs bg-blue text-white rounded-full">신규</span>
              </div>
              <p className="text-mobile-small text-darkgray mt-1">
                2024년 1학기 수강신청이 시작되었습니다.
              </p>
            </div>
            <div className="p-3 bg-green/10 rounded-lg border-l-4 border-green">
              <div className="flex items-center justify-between">
                <span className="text-mobile-small-bold">장학금 지급</span>
                <span className="px-2 py-1 text-xs bg-green text-white rounded-full">완료</span>
              </div>
              <p className="text-mobile-small text-darkgray mt-1">
                성적우수장학금이 지급되었습니다.
              </p>
          ...
          <div className="space-y-3">
            <div className="border-b border-lightgray pb-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-mobile-small text-coolgray">2024.01.15</span>
              </div>
              <p className="text-mobile-small text-darkgray mt-1">
            ...
            <div className="border-b border-lightgray pb-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-mobile-small text-coolgray">2024.01.12</span>
              </div>
              <p className="text-mobile-small text-darkgray mt-1">
            ...
            <div className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-mobile-small text-coolgray">2024.01.10</span>
              </div>
              <p className="text-mobile-small text-darkgray mt-1">
